        ...
        *,
        ...
        async with stream.lock:
            ...
            try:
                ...
                # Slack rejects chat.appendStream requests that provide both
                # native task-card chunks and markdown_text. fallback_text is
                # reserved for the gateway's editable-text fallback path.
